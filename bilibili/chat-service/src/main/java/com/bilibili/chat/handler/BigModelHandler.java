package com.bilibili.chat.handler;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.bilibili.chat.domain.entity.ChatMessage;
...
import static com.bilibili.chat.handler.WebSocketHandler.USERID_TO_SESSIONID_MAP;
import static com.bilibili.chat.handler.WebSocketHandler.WEB_SOCKET_SESSION_CONCURRENT_MAP;
    ...
    public void onMessage(WebSocket webSocket, String text) {
        try {
            ...
            for (Text temp : textList) {
                ...
                try {
                    WEB_SOCKET_SESSION_CONCURRENT_MAP.get(USERID_TO_SESSIONID_MAP.get(chatMessage.getUserId()))
