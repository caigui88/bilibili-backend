...
import com.bilibili.chat.domain.vo.ImageVO;
...
//            System.out.println(closeableHttpResponse);
            ...
            ObjectMapper objectMapper=new ObjectMapper();
             imageVO =objectMapper.readValue(resultString, ImageVO.class);
            int i=0;
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
        ...
        return imageVO.getPayload().choices.text.get(0).content;
    }
